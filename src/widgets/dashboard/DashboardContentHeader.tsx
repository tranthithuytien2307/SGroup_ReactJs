  ...
  return (
    <div className="flex justify-between items-center">
      ...
      <Button
        ...
        className="whitespace-normal inline-flex items-center justify-center gap-2 rounded-md text-sm font-medium cursor-pointer bg-black text-white"
      >
